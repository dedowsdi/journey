package
{
    ...
    public class BitmapNoise extends Sprite{
        ...
        protected function onLoad(evt:Event):void
        {
            ...
            bitmap0 = createBitmap(0, 0);
            bmp0 = bitmap0.bitmapData;
            bitmap0.blendMode = BlendMode.MULTIPLY;

            bitmap1 = createBitmap((src.width + 10),  0);
            bmp1 = bitmap1.bitmapData;

            bitmap2 = createBitmap((src.width + 10), (src.height + 10) * 1);
            bmp2 = bitmap2.bitmapData;

            // bitmap3 = createBitmap((src.width + 10), (src.height + 10) * 2);
            // bmp3 = bitmap3.bitmapData;
