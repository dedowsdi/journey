...
public:
  ...
  explicit mixin_vector() : _impl() {}

  explicit mixin_vector(
    size_type initial_size, const value_type& fill_value = value_type())
      : _impl(initial_size, fill_value) {}

  template <class InputIterator>
  mixin_vector(InputIterator first, InputIterator last) : _impl(first, last) {}

  mixin_vector(const vector_type& other) : _impl(other) {}
  ...
  const vector_type& get_vector() const {return _impl;}
  ...
  void swap(mixin_vector& other) { _impl.swap(other._impl); }
