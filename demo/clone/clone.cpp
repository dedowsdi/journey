...
int main(int argc, char** argv) {
  ...
  osg::ref_ptr<osg::Geode> geode2 =
    dynamic_cast<osg::Geode*>(geode1->clone(osg::CopyOp::SHALLOW_COPY));
  //deep copy
  osg::ref_ptr<osg::Geode> geode3 =
    dynamic_cast<osg::Geode*>(geode1->clone(osg::CopyOp::DEEP_COPY_ALL));

  osg::ref_ptr<osg::Group> root = new osg::Group;
  root->addChild(
    createMatrixTransform(geode1.get(), osg::Vec3(0.0f, 0.0f, 0.0f)));
  root->addChild(
    createMatrixTransform(geode2.get(), osg::Vec3(-2.0f, 0.0f, 0.0f)));
  root->addChild(
    createMatrixTransform(geode3.get(), osg::Vec3(2.0f, 0.0f, 0.0f)));
