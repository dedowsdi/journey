...
osg::Node* createNeedle(float w, float h, float depth, const osg::Vec4& color,
  ...
  clockPath->insert(
    0.0, osg::AnimationPath::ControlPoint(
           osg::Vec3(0.0f, depth, 0.0f), osg::Quat(initAngle, osg::Y_AXIS)));
  clockPath->insert(
    period * 0.5, osg::AnimationPath::ControlPoint(osg::Vec3(0.0f, depth, 0.0f),
                    osg::Quat(initAngle + osg::PI, osg::Y_AXIS)));
  clockPath->insert(
    period, osg::AnimationPath::ControlPoint(osg::Vec3(0.0f, depth, 0.0f),
              osg::Quat(initAngle + osg::PI * 2.0f, osg::Y_AXIS)));
...
osg::Node* createFace(float radius) {
  ...
  geom->setColorArray(colors.get());
  geom->setColorBinding(osg::Geometry::BIND_OVERALL);
  geom->addPrimitiveSet(new osg::DrawArrays(GL_TRIANGLE_FAN, 0, 66));
...
int main(int argc, char** argv) {
  float hour_time = 10.0f, min_time = 30.0f, sec_time = 0.0f; //current time
  osg::Node* hour = createNeedle(6.0f, 1.0f, -0.02f,
    osg::Vec4(1.0f, 0.0f, 0.0f, 1.0f), hour_time * osg::PI / 6.0f, 3600 * 60.0);
  osg::Node* minute = createNeedle(8.0f, 0.6f, -0.04f,
    osg::Vec4(0.0f, 1.0f, 0.0f, 1.0f), min_time * osg::PI / 30.0f, 3600.0);
  osg::Node* second = createNeedle(10.0f, 0.2f, -0.06f,
    osg::Vec4(1.0f, 1.0f, 0.0f, 1.0f), sec_time * osg::PI / 30.0f, 60.0);
