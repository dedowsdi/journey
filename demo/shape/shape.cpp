...
int main(int argc, char *argv[]) {
  ...
  // create shapedrawables, shapedrawables is not a efficient way of drawing
  // geometry primitives, it should be used only for quick prototyping and
  // debugging.
  osg::ref_ptr<osg::ShapeDrawable> shape1 = new osg::ShapeDrawable;
  shape1->setShape(
    new osg::Box(osg::Vec3(-3.0f, 0.0f, 0.0f), 2.0f, 2.0f, 1.0f));
