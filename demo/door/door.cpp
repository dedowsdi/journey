...
osg::Node* createWall() {
  osg::ref_ptr<osg::ShapeDrawable> wallLeft = new osg::ShapeDrawable(
    new osg::Box(osg::Vec3(-5.5f, 0.0f, 0.0f), 10.0f, 0.3f, 10.0f));
  osg::ref_ptr<osg::ShapeDrawable> wallRight = new osg::ShapeDrawable(
    new osg::Box(osg::Vec3(10.5f, 0.0f, 0.0f), 10.0f, 0.3f, 10.0f));
...
osg::MatrixTransform* createDoor() {
  osg::ref_ptr<osg::ShapeDrawable> doorShape = new osg::ShapeDrawable(
    new osg::Box(osg::Vec3(2.5f, 0.0f, 0.0f), 6.0f, 0.2f, 10.0f));
...
class OpenDoorHandler : public zxd::PickHandler {
public:
  ...
  virtual void doUserOperations(
    ...
    osg::NodePath::iterator itr =
      std::find(result.nodePath.begin(), result.nodePath.end(), _door.get());
    if (itr != result.nodePath.end()) {
      if (_manager->isPlaying(_animation.get())) return; //do nothing if it's animating
