...
#include "currency_model.h"

int main(int argc, char *argv[])
{
    QApplication app(argc, argv);

    // currencies related to U.S. dollar
    ...
    rect.setWidth(tableView.verticalHeader()->width() + 2 + tableView.columnWidth(0) * currencyModel.columnCount());
    rect.setHeight(tableView.horizontalHeader()->height() + 2 + tableView.rowHeight(0) * currencyModel.rowCount());
