...
// in hierarchical model, row is used as child index in it's direct parent
                                ...
                                const QModelIndex &parent) const
{
    ...
    if (!childNode)
        return QModelIndex();
    // For hierarchical models, knowing the row and column of an item relative
    // to its parent is not enough to uniquely identify it; we must also know
    // who its parent is.
