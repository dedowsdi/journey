...
/*
 * You can't chagne direction arbitary, it must ensure winding order in this
 * demo.
 */
...
osg::Geometry* createExtrusion(
  ...
  // create top vertices in reverse order to keep winding order
  ...
  // add bottom and top primitive set
